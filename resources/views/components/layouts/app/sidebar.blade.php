        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:navlist.item icon="cube" :href="route('budget.manage')" :current="request()->routeIs('budget.manage')" wire:navigate>{{ __('Budget') }}</flux:navlist.item>
                    <flux:navlist.item icon="arrow-trending-up" :href="route('income.manage')" :current="request()->routeIs('income.manage')" wire:navigate>{{ __('My Income') }}</flux:navlist.item>
                    <flux:navlist.item icon="credit-card" :href="route('payment-methods.manage')" :current="request()->routeIs('payment-methods.manage')" wire:navigate>{{ __('Payment Method') }}</flux:navlist.item>
                    <flux:navlist.item icon="arrow-trending-down" :href="route('expenses.manage')" :current="request()->routeIs('expenses.manage')" wire:navigate>{{ __('Expense') }}</flux:navlist.item>
